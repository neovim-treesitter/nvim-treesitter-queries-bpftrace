# nvim-treesitter-queries-bpftrace

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-bpftrace/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-bpftrace/actions/workflows/validate.yml)

Neovim tree-sitter queries for **bpftrace**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-bpftrace",
...
- [ ] Changes are scoped to `bpftrace` — do not include files for other languages
